...
# C=() : 분류정확도를 조정 - L2규제(정규화) : 값이 작을수록 규제가 강하다.(과적합 모델이 될 확률이 적어짐)
# multi_class='auto' 또는 'multinomial', 'ovr'  : multinomial는 softmax사용  ,, 이항일땐 ovr 다항일땐 multinomial
# solver='lbfgs' : softmax지원
# verbose=0 : 학습 진행 과정 출력 여부(0,1,2)
print(model)
# ----------------------------
